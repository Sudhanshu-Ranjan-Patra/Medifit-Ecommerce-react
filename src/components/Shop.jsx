  ...
  <div className="bg-[#f5f4ef] min-h-screen px-4 py-8 font-sans pt-20">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="col-span-1 flex flex-col items-center md:items-start">
        <img
          src="../images/shop-home-1.png"
          alt="B12 Medicine"
          className="rounded-xl w-60 h-44 object-cover"
        />
        <img
          src="../images/shop-home-2.png"
          alt="Capsules"
          className="rounded-xl w-60 h-44 object-cover mt-6"
        />
      </div>
      <div className="col-span-2 flex flex-col">
        <h1 className="text-3xl font-semibold text-[#48341d] mb-2">
          B12 Medicine
        </h1>
        <div className="flex items-center gap-5 mb-3">
          <span className="text-2xl text-[#48341d] font-semibold">
            $19.00 USD
          </span>
        ...
        <div className="flex items-center gap-2 mb-3">
          <input
            ...
            min="1"
            defaultValue={1}
            className="bg-[#f3eee5] border border-gray-200 rounded px-3 py-1 w-16"
          />
          <button className="bg-[#48341d] text-white px-6 py-2 rounded shadow hover:bg-[#624d2f]">
            Add to cart
          </button>
        </div>
        <div>
          <h2 className="font-medium text-[#48341d] mb-1">
            Product Description
          </h2>
          <p className="text-gray-700 text-[15px] mb-3 max-w-xl">
            B12 Medicine is a premium supplement that combats B12 deficiency and
            supports energy, red blood cell formation, and nervous system
            health. Perfect for those with fatigue, anemia, or restricted diets
    ...
    <div className="max-w-6xl mx-auto mt-10">
      <h2 className="text-xl font-semibold text-[#48341d] mb-3">
        Recent Products
      </h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        {PRODUCT_LIST.map((prod, i) => (
          ...
          >
            {prod.tag && (
              <span className="bg-amber-100 text-amber-700 px-2 py-0.5 rounded text-xs mb-2">
                {prod.tag}
              </span>
            )}
            <img src={prod.image} className="w-20 h-30  mb-2" alt={prod.name} />
            <h3 className="font-semibold text-[#48341d] mb-1 text-sm">
              {prod.name}
            </h3>
            <div className="flex items-center gap-2">
              <span className="text-[#48341d]">${prod.price}.00 USD</span>
              {prod.oldPrice && (
                <span className="line-through text-[#bbb]">
                  ${prod.oldPrice}.00 USD
                </span>
              )}
            </div>
          </div>
    ...
    <div className="max-w-6xl mx-auto mt-12 grid md:grid-cols-2 gap-6 items-center bg-white p-7 rounded-2xl shadow">
      <div>
        <h3 className="text-2xl font-semibold text-[#48341d] mb-2">
          Join our trustable Medift product community
        </h3>
      ...
      <div className="grid grid-cols-2 gap-3">
        <img
          src="/assets/capsule-bottle.jpg"
          className="rounded w-full h-24 object-cover"
          alt=""
        />
        <img
          src="/assets/pill-strip.jpg"
          className="rounded w-full h-24 object-cover"
          alt=""
        />
        <img
          src="/assets/lab-medicines.jpg"
          className="rounded w-full h-24 object-cover"
          alt=""
        />
        <img
          src="/assets/assorted-pills.jpg"
          className="rounded w-full h-24 object-cover"
          alt=""
        />
      </div>
